package com.example.medicare.Utilities.StepView;
...
public class VerticalStepViewIndicator extends View {
    ...
    private final int defaultStepIndicatorNum = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 40, getResources().getDisplayMetrics());
    ...
    private Paint mUnCompletedPaint;//  definition mUnCompletedPaint
    private Paint mCompletedPaint;//      definition mCompletedPaint
    private int mUnCompletedLineColor = ContextCompat.getColor(getContext(), R.color.uncompleted_color);//  definition mUnCompletedLineColor
    private int mCompletedLineColor = Color.WHITE;//      definition mCompletedLineColor
    private PathEffect mEffects;

    private int mComplectingPosition;//   underway position
    private Path mPath;
