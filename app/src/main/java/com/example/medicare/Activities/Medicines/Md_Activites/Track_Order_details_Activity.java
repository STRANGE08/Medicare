...
public class Track_Order_details_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (status.equalsIgnoreCase("open")) {
            ...
            list0.add("Ordered ");
            list0.add("Expected Delivery on 26 Jan 22");
...
//            list0.add("Out for Delivery \n Today");
            mSetpview0.setStepsViewIndicatorComplectingPosition(list0.size()-2 )
                    ...
                    .setStepsViewIndicatorUnCompletedLineColor(ContextCompat.getColor(Track_Order_details_Activity.this, R.color.grey))
                    .setStepViewComplectedTextColor(ContextCompat.getColor(Track_Order_details_Activity.this, R.color.black))
                    .setStepViewUnComplectedTextColor(ContextCompat.getColor(Track_Order_details_Activity.this, R.color.grey))
